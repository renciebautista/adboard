                ...
                function updateCount() {
                  ...
                  $.getJSON("/hmi/api.php", 
                    function(json){
                      ...
                      $('#mta').text(json.mta);
                      $('#fa').text(json.fa);
                      $('#nm_ty').text(json.nm_ty);
                      $('#nm_cl').text(json.nm_cl);
                      $('#nm_op').text(json.nm_op);
                      $('#so_ub').text(json.so_ub);
                      $('#so_uc').text(json.so_uc);
                      $('#so_ty').text(json.so_ty);
                      $('#so_cl').text(json.so_cl);
                      $('#so_op').text(json.so_op);
                      $('#last_day').text(json.last_day);
